...
$( "#seeMore" ).on( "click", function() { 
	...
	$.ajax({
		...
		var html2='<div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;"><div class="menu-column"><div class="food"><div class="food-desc"><h6 class="food-name">'+data.content[0].dish+'</h6><div class="dots"></div><div class="food-price"><span>'+data.content[0].price+'€</span></div></div><div class="food-details"><span>'+data.content[0].description+'</span></div></div></div></div>';
		if(data.content[1]!=null){
			html2+='<div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;"><div class="menu-column"><div class="food"><div class="food-desc"><h6 class="food-name">'+data.content[1].dish+'</h6><div class="dots"></div><div class="food-price"><span>'+data.content[1].price+'€</span></div></div><div class="food-details"><span>'+data.content[1].description+'</span></div></div></div></div>';
			}if(data.content[2]!=null){
				html2+='<div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;"><div class="menu-column"><div class="food"><div class="food-desc"><h6 class="food-name">'+data.content[2].dish+'</h6><div class="dots"></div><div class="food-price"><span>'+data.content[2].price+'€</span></div></div><div class="food-details"><span>'+data.content[2].description+'</span></div></div></div></div>';
				}if(data.content[3]!=null){
					html2+='<div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;"><div class="menu-column"><div class="food"><div class="food-desc"><h6 class="food-name">'+data.content[3].dish+'</h6><div class="dots"></div><div class="food-price"><span>'+data.content[3].price+'€</span></div></div><div class="food-details"><span>'+data.content[3].description+'</span></div></div></div></div>';
				}else{
				$("#seeMore").hide();
				}
		$("#menus").append(html2);
